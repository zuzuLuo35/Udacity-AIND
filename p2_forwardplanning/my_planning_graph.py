...
class ActionLayer(BaseActionLayer):
    ...
    def _inconsistent_effects(self, actionA, actionB):
        ...
        return (any(~e_b in actionA.effects for e_b in actionB.effects) or \
                any(~e_a in actionB.effects for e_a in actionA.effects))
    ...
    def _interference(self, actionA, actionB):
        ...
        # TODO: implement this function
        # raise NotImplementedError
        return (any(~e_b in actionA.preconditions for e_b in actionB.effects) or \
                any(~e_a in actionB.preconditions for e_a in actionA.effects))
    ...
    def _competing_needs(self, actionA, actionB):
        ...
        # TODO: implement this function
        # raise NotImplementedError
        return (any(self.parent_layer.is_mutex(prec_a, prec_b) for prec_a in actionA.preconditions for prec_b in actionB.preconditions) or \
                any(self.parent_layer.is_mutex(prec_b, prec_a) for prec_b in actionB.preconditions for prec_a in actionA.preconditions))
...
class LiteralLayer(BaseLiteralLayer):
    ...
    def _inconsistent_support(self, literalA, literalB):
        ...
        # TODO: implement this function
        # raise NotImplementedError
        return (all(self.parent_layer.is_mutex(actionA, actionB) for actionA in self.parents[literalA] for actionB in self.parents[literalB]) and \
                all(self.parent_layer.is_mutex(actionB, actionA) for actionB in self.parents[literalB] for actionA in self.parents[literalA]))
